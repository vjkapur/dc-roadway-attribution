...
# but there could be other ways to consider protection (for instance, parking adjacent but not drive adjacent lanes)
bike_lanes_eckert4[['BIKELANE_PROTECTED', 'BIKELANE_DUAL_PROTECTED']].any(axis=1)
